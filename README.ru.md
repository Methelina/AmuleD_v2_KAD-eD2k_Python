...
Это ранний, но живой клиент: поиск (включая KAD) и приём источников работают против реальной сети eMule, а пиринговые соединения используют обязательную TCP-обфускацию. Ещё в разработке: завершение закачек от KAD-источников end-to-end, отдача файлов другим (upload), публикация ваших файлов в KAD-сети, входящие соединения. Следить за прогрессом можно в roadmap (секции помечены DONE/WIP/PLANNED).
